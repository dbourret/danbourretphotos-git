...
function initRestorationShowcase() {
  const compare = document.getElementById("restoration-compare");
  const slider = document.getElementById("restoration-slider-input");
  const afterWrap = document.getElementById("restoration-after-wrap");
  const divider = document.getElementById("restoration-divider");
  const handle = document.getElementById("restoration-handle");
  const beforeImage = document.getElementById("restoration-before-image");
  const afterImage = document.getElementById("restoration-after-image");
  ...
  if (!compare || !slider || !afterWrap || !divider || !handle) return;

  const examples = [
    {
      title: "Wedding Reception",
      before: "images/restoration-samples/wedding-reception-before.jpg",
      after: "images/restoration-samples/wedding-reception-after.png",
      beforeAlt: "Original faded wedding reception photograph",
      afterAlt: "Restored wedding reception photograph",
      description:
        "Restored severe fading, corrected the color balance, improved contrast, and recovered detail while preserving the original character.",
    },
    {
      title: "Wedding Toast",
      before: "images/restoration-samples/wedding-toast-before.jpg",
      after: "images/restoration-samples/wedding-toast-after.png",
      beforeAlt: "Original faded wedding toast photograph",
      afterAlt: "Restored wedding toast photograph",
      description:
        "Recovered natural skin tones, removed the heavy color cast, improved clarity, and restored detail throughout the photograph.",
    },
    {
      title: "Wedding Hallway",
      before: "images/restoration-samples/wedding-hallway-before.jpg",
      after: "images/restoration-samples/wedding-hallway-after.png",
      beforeAlt: "Original faded wedding hallway photograph",
      afterAlt: "Restored wedding hallway photograph",
      description:
        "Corrected exposure and color, restored natural skin tones, reduced fading, and sharpened important facial and clothing details.",
    },
    {
      title: "Family Portrait Colorization",
      before: "images/restoration-samples/family-portrait-before.jpg",
      after: "images/restoration-samples/family-portrait-after.png",
      beforeAlt: "Original black-and-white family portrait",
      afterAlt: "Restored and colorized family portrait",
      description:
        "Cleaned and colorized a black-and-white portrait while preserving facial character, clothing texture, and the original setting.",
    },
  ];
  ...
  function syncAfterImageWidth() {
    ...
    afterImage.style.height = `${compare.clientHeight}px`;
  }

  function renderExample() {
    const example = examples[current];

    beforeImage.src = example.before;
    beforeImage.alt = example.beforeAlt;
    afterImage.src = example.after;
    afterImage.alt = example.afterAlt;
    title.textContent = example.title;
    description.textContent = example.description;
    count.textContent = `${current + 1} of ${examples.length}`;

    slider.value = "50";
    setReveal(50);

    requestAnimationFrame(syncAfterImageWidth);
  }

  slider.addEventListener("input", () => setReveal(slider.value));

  prev?.addEventListener("click", () => {
    current = (current - 1 + examples.length) % examples.length;
    renderExample();
  });
  ...
  afterImage?.addEventListener("load", syncAfterImageWidth);
