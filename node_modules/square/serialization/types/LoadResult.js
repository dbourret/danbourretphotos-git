...
const LoadResultData_1 = require("./LoadResultData");
exports.LoadResult = core.serialization.object({
    dataSource: core.serialization.string().optional(),
    annotation: LoadResultAnnotation_1.LoadResultAnnotation,
    data: LoadResultData_1.LoadResultData,
